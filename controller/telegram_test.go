...
func TestVerifyTelegramAuthorization(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "registration invite is not part of Telegram signature", authDate: now, mutate: func(values url.Values) { values.Set("invite_code", "INVITE-CODE") }, wantID: "123456"},
