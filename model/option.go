...
func InitOptionMap() {
	...
	common.OptionMap["RegistrationInviteRequired"] = strconv.FormatBool(common.RegistrationInviteRequired)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" || key == "RegistrationInviteRequired" {
		...
		case "RegistrationInviteRequired":
			common.RegistrationInviteRequired = boolValue
